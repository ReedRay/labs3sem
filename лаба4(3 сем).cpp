...
{
public:
	SemiDeteched(double living, int number, int id = 0, int address = 0, int floors = 1, std::string type1 = "SemiDeteched") :m_living_area(living), m_number_of_neighbours(number), Deteched(id, address)
	{
		m_floors = floors;
		m_type = type1;
	}
