...
class SemiDeteched : virtual public Deteched
{
public:
	SemiDeteched(double living, int number, int id = 0, int address = 0, int floors = 1, std::string type1 = "SemiDeteched") :m_living_area(living), m_number_of_neighbours(number), Deteched(id, address), House(floors, type1)
	{
...
class Studio : virtual public Flat
{
public:
	~Studio()
	{
	...
	Studio(int rooms = 1, int persons = 2, int id = 0, int post_index = 0, int floors = 1, std::string type = "Studio") :m_number_of_rooms(rooms), m_persons_to_live(persons), Flat(id, post_index)
	{
		m_floors = floors;
		m_type = type;
	}
...
class Mansion : virtual public SemiDeteched, virtual public Studio
{
public:
	Mansion(int id, int addres_line, int neighbours, int numbers_rooms, int postindex, double living_area, double general)
	{
		m_id = id;
